...
<div class="timeline-item">
  ...
  <div class="timeline-desc">
    <ul>
      ...
      <li>Led development of a Monolith SDK for Meteor/Rocket.Chat integration.</li>
    </ul>
  </div>
</div>
...
<div class="card-grid">
  ...
  <a href="https://github.com/smeneguz/dao-data-visualization" target="_blank" class="card" style="text-decoration: none;">
    <div class="card-label">DAO Research</div>
    <h3>dao-data-visualization</h3>
    <p>Visual exploration of DAO governance KPIs with data pipelines for on-chain analysis.</p>
    <div class="tag-list">
      <span class="tag">JavaScript</span>
  ...
  <a href="https://github.com/smeneguz/Swapfee-Dynamic-Gas" target="_blank" class="card" style="text-decoration: none;">
    <div class="card-label">DApp</div>
    <h3>Swapfee-Dynamic-Gas</h3>
    <p>DApp prototype for IOTA with dynamic fee mechanisms. 3rd place at IOTA Hackathon Cagliari 2024.</p>
    <div class="tag-list">
